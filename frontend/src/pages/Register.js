              ...
              <form action="/" className="mt-8 grid grid-cols-6 gap-6">
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    className="mt-1 w-full h-10 border rounded-md border-gray-400 bg-white text-sm text-gray-700 shadow-sm"
                  />
                </div>
                ...
                <div className="col-span-6">
                  <label htmlFor="MarketingAccept" className="flex gap-4">
                    <input
                      ...
                      className="h-5 w-5 h-10 border rounded-md border-gray-400 bg-white shadow-sm"
                    />
